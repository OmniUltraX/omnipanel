...
pub use first_party::{
    PLUGIN_ID_ADDON_EVERYTHING, PLUGIN_ID_CLOUD_ALIYUN, PLUGIN_ID_CLOUD_AWS, PLUGIN_ID_CLOUD_AZURE,
    PLUGIN_ID_CLOUD_BANDWAGON, PLUGIN_ID_CLOUD_DIGITALOCEAN, PLUGIN_ID_CLOUD_GCP,
