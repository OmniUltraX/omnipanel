...
async fn status_handler(State(_ctx): State<AppCtx>) -> impl IntoResponse {
    Json(serde_json::json!({
        ...
        "p2_file_commands": ["file_list_connections", "file_list_dir", "file_read_file", "file_upload_file", "file_mkdir", "file_rename", "file_delete", "file_local_quick_paths", "file_local_system_info", "file_upload_local_bytes", "file_download_file"],
        "p2_ai_commands": ["ai_chat_stream", "ai_chat_cancel", "ai_http_stream_post"],
        "p3_ai_tools": ["ai_chat_tool_result", "tools: omni_ssh_exec/omni_ssh_get_stats/omni_ssh_create_run_script/omni_docker_*/omni_database_*/omni_files_* + Native 知识库/skill/web"],
