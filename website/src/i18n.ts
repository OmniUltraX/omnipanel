...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.21：快捷启动页内询问 AI 与询问记录、插件工作室闭环、模块窗 10 分钟空闲卸载。",
  "highlights.web.h": "插件平台",
  "highlights.web.p": "插件中心 + 工作室校验/打包/安装闭环；官方验签与投稿；多源安装",
  ...
  "highlights.termAi.h": "快捷启动",
  "highlights.termAi.p": "页内询问 AI（流式 + Markdown）；询问记录与收藏；场景模型芯片",
  "highlights.db.h": "面板应用",
  "highlights.db.p": "宝塔已装应用版本/端口；MySQL / Redis 一键管理参数",
  "highlights.sec.h": "性能",
  "highlights.sec.p": "模块保活秒切；模块窗隐藏 10 分钟空闲卸载；看板隐藏停轮询",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.21: Quick Launcher in-panel Ask AI + history, plugin studio loop, module windows idle-unload after 10m.",
  "highlights.web.h": "Plugin platform",
  "highlights.web.p": "Plugin Center + studio pack/install loop; official verify & submissions; multi-source install",
  ...
  "highlights.termAi.h": "Quick Launcher",
  "highlights.termAi.p": "In-panel Ask AI (stream + Markdown); ask history with favorites; scene model chip",
  "highlights.db.h": "Panel apps",
  "highlights.db.p": "BT installed apps show version/port; MySQL / Redis one-click manage params",
  "highlights.sec.h": "Performance",
  "highlights.sec.p": "Keep-alive module switch; idle-unload module windows after 10m hidden; stop widget polling when hidden",
  "modules.eyebrow": "Core Modules",
