...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.5：团队同步端到端加密与侧栏切换，表预览查询历史，终端路径点击与多项稳定性修复。",
  "highlights.web.h": "团队同步",
  "highlights.web.p": "侧栏切换同步团队；快照整包加密写入 OSS；密码走 vault",
  "highlights.panel.h": "表数据预览",
  "highlights.panel.p": "WHERE / ORDER BY 按表记忆历史，↑/↓ 快速回填",
  "highlights.ssh.h": "终端 · 路径点击",
  "highlights.ssh.p": "输出中的文件路径可点击打开预览或定位",
  "highlights.termAi.h": "AI · harness",
  "highlights.termAi.p": "统一提示词分层与工具路由，终端与 Agent 协作更一致",
  "highlights.db.h": "同步安全",
  "highlights.db.p": "成员身份校验；自定义团队不同步密码；兼容历史明文快照",
  "highlights.sec.h": "稳定性",
  "highlights.sec.p": "关 Tab 不清空终端；思考卡 / IME / Ubuntu 中文输入等修复",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.5: End-to-end encrypted team sync with sidebar switching, table query history, clickable terminal paths, and stability fixes.",
  "highlights.web.h": "Team sync",
  "highlights.web.p": "Switch sync team from the sidebar; snapshots encrypted before OSS; passwords stay in the vault",
  "highlights.panel.h": "Table preview",
  "highlights.panel.p": "Per-table WHERE / ORDER BY history with ↑/↓ recall",
  "highlights.ssh.h": "Terminal · path clicks",
  "highlights.ssh.p": "Click file paths in terminal output to open preview or jump",
  "highlights.termAi.h": "AI · harness",
  "highlights.termAi.p": "Unified prompt layers and tool routing for terminal and Agent collaboration",
  "highlights.db.h": "Sync security",
  "highlights.db.p": "Membership checks; custom teams never sync passwords; legacy plaintext still readable",
  "highlights.sec.h": "Stability",
  "highlights.sec.p": "Closing tabs no longer clears terminals; thinking-card / IME / Ubuntu CJK input fixes",
  "modules.eyebrow": "Core Modules",
