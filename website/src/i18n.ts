...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.31：同步资源自动安装官方插件、云厂商侧栏标准化、模块切换不再扫侧栏挂壳。",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.31: Auto-install official plugins after sync, standardized cloud sidebar, module switch no longer premounts on hover.",
