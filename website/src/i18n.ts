...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.15：云厂商 + 模块插件工作台、在场验证（presence）、sidecar 数据库引擎与安全能力全面落地。",
  "highlights.web.h": "插件平台",
  "highlights.web.p": "插件中心：官方目录 + 第三方 DBX；签名 .omni-plugin；L2 / L3 沙箱",
  ...
  "highlights.termAi.h": "云厂商",
  "highlights.termAi.p": "阿里云 / 腾讯云能力工作台；账号上切地区；可安装 Nacos 模块插件",
  "highlights.db.h": "数据库导出",
  "highlights.db.p": "修复团队同步后 SSH 池滞后导致的远程导出失败",
  "highlights.sec.h": "性能",
  "highlights.sec.p": "取消模块窗启动预热，首次打开再创建，降低常驻内存",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.15: Cloud vendors + module-plugin workbench, presence-based guard, sidecar DB engines & security capabilities.",
  "highlights.web.h": "Plugin platform",
  "highlights.web.p": "Plugin Center: official catalog + third-party DBX; signed .omni-plugin; L2 / L3 sandbox",
  ...
  "highlights.termAi.h": "Cloud vendors",
  "highlights.termAi.p": "Aliyun / Tencent Cloud workbench; switch region on the account; installable Nacos module",
  "highlights.db.h": "Database export",
  "highlights.db.p": "Fix remote export after team sync when SSH pool was stale",
  "highlights.sec.h": "Performance",
  "highlights.sec.p": "No module-window prewarm at startup — create on first open, lower idle memory",
  "modules.eyebrow": "Core Modules",
