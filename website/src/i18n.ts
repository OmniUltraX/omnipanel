...
const zh: Dict = {
  ...
  "meta.desc":
    "OmniPanel 将终端、SSH、数据库、Docker、服务器管理、协议调试与 AI 辅助集成于单一桌面应用。一个窗口，贯穿开发运维上下文。",
  "nav.showcase": "实机界面",
  "nav.modules": "核心模块",
  "nav.ai": "AI 原生",
  ...
  "arch.lead":
    "单二进制、内存安全、凭据本地存储。React 前端 + Rust 后端 IPC，模块能力收敛在 omnipanel-* crates。",
  "arch.ui": "UI 层",
  "arch.mod": "模块层",
  "arch.eng": "引擎层",
  "arch.store": "存储层",
  ...
  "contact.title": "联系我们",
  "contact.lead": "商务合作、技术支持与企业采购，可通过企业邮箱或微信公众号联系我们。",
...
const en: Dict = {
  ...
  "meta.desc":
    "OmniPanel unifies terminal, SSH, databases, Docker, server ops, protocol debugging, and AI in one desktop app.",
  "nav.showcase": "Demo",
  "nav.modules": "Modules",
  "nav.ai": "AI",
  ...
  "modules.eyebrow": "Core Modules",
  "modules.title": "Eight modules covering day-to-day engineering ops",
  "mod.terminal.p":
  ...
  "arch.lead":
    "Single binary, memory-safe, credentials on device. React UI + Rust IPC; capabilities live in omnipanel-* crates.",
  "arch.ui": "UI",
  "arch.mod": "Modules",
  "arch.eng": "Engine",
  "arch.store": "Storage",
  ...
  "contact.lead":
    "For business, support, and enterprise licensing — email us or follow our WeChat Official Account.",
