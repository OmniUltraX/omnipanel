...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.8：同步加密 v2（团队密钥 + 在线中继传钥）、助手绑定 v2 与加密摘要通道。",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.8: Sync crypto v2 (team key + online relay), assistant bind v2 & encrypted payload channel.",
