...
const zh: Dict = {
  ...
  "mod.server.p": "系统监控、进程与远程文件；宝塔 / 1Panel / HestiaCP 网站·应用·证书·计划任务；自定义监控面板与小组件；阿里云 / 腾讯云在账号上切换地区。",
...
const en: Dict = {
  ...
  "mod.server.p":
    "System metrics, processes, remote files; BT / 1Panel / HestiaCP sites·apps·certs·cron; custom monitor panels & widgets; Aliyun / Tencent Cloud region switch on the account.",
