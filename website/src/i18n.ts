...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.33：SQL 编辑器右键与简单格式化，连接树祖先吸顶，二进制日志与慢日志按时间加载。",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.33: SQL editor context menu and compact format, sticky schema-tree ancestors, binlog and slow log load in time order.",
