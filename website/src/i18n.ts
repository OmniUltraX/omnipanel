...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.2：账号级云端同步、面板应用安装日志，并优化 SSH 侧栏分区高度记忆。",
  "highlights.web.h": "账号级同步",
  "highlights.web.p": "登录拉取账号级云端快照，多端共享同一份同步数据",
  "highlights.panel.h": "应用安装日志",
  "highlights.panel.p": "宝塔 / 1Panel 应用安装可查看进度与失败详情",
  "highlights.ssh.h": "团队 · OSS 同步",
  "highlights.ssh.p": "邮箱邀请成员、数据预览、同步排除与自定义面板团队分享",
  "highlights.termAi.h": "SSH · 进程监控",
  "highlights.termAi.p": "主机概览与进程轮询；进程详情命令行解析与缓存",
  "highlights.db.h": "自定义监控面板",
  "highlights.db.p": "网格拖拽布局；主机 / Docker / MySQL / Redis 等监控小组件",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.2: account-level cloud sync, panel app install logs, and SSH sidebar section height memory.",
  "highlights.web.h": "Account sync",
  "highlights.web.p": "Login pulls a shared account-level cloud snapshot across devices",
  "highlights.panel.h": "App install logs",
  "highlights.panel.p": "Live install progress and error details for BT / 1Panel apps",
  "highlights.ssh.h": "Teams · OSS sync",
  "highlights.ssh.p": "Email invites, data preview, sync exclusions, and custom panel sharing to team members",
  "highlights.termAi.h": "SSH · Process monitor",
  "highlights.termAi.p": "Live polling on host overview; cached command-line in process details",
  "highlights.db.h": "Custom monitor panels",
  "highlights.db.p": "Drag-and-drop grid panels with host / Docker / MySQL / Redis widgets",
