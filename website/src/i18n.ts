...
const zh: Dict = {
  ...
  "highlights.lead": "v0.7.x 持续交付：Web 版、面板集成、终端 AI、数据库与跨端安全能力。",
  "highlights.web.h": "Web 版",
  "highlights.web.p": "浏览器访问 + GHCR 公开镜像，Render / Zeabur / Railway 等一键部署",
  "highlights.panel.h": "面板集成",
  "highlights.panel.p": "宝塔 / 1Panel 四域，1Panel v1/v2 兼容，云厂商资源入口",
  "highlights.ssh.h": "SSH / 文件",
  "highlights.ssh.p": "tmux 远端会话治理，跨连接传输与超大日志预览",
  "highlights.termAi.h": "终端 AI",
  "highlights.termAi.p": "直通 Shell Agent、Plan / ask_user 卡片、危险命令二次确认",
  "highlights.db.h": "数据库",
  "highlights.db.p": "侧栏 SQL 查询、虚拟滚动网格、NL2SQL、Schema 全树检索",
  "highlights.sec.h": "安全",
  "highlights.sec.p": "Vault 钥匙串凭据、设备码跨端同步、敏感信息脱敏",
  ...
  "mod.docker.p": "容器、镜像、Compose、网络、卷；本地 / 远程 Engine / SSH 宿主机 / 1Panel。",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.7.x: Web edition, panel integration, terminal AI, database, and cross-device security.",
  "highlights.web.h": "Web edition",
  "highlights.web.p": "Browser UI + public GHCR image; one-click deploy on Render, Zeabur, Railway, and more",
  "highlights.panel.h": "Panel integration",
  "highlights.panel.p": "BT / 1Panel domains; 1Panel v1/v2; cloud vendor entry",
  "highlights.ssh.h": "SSH / Files",
  "highlights.ssh.p": "tmux session governance; cross-connection transfer and large log preview",
  "highlights.termAi.h": "Terminal AI",
  "highlights.termAi.p": "Passthrough shell agent; Plan / ask_user cards; dangerous-command confirmation",
  "highlights.db.h": "Database",
  "highlights.db.p": "Sidebar SQL query; virtual-scroll grid; NL2SQL; full-schema search",
  "highlights.sec.h": "Security",
  "highlights.sec.p": "Vault keyring credentials; device-code sync; secret redaction",
  "modules.eyebrow": "Core Modules",
  ...
  "mod.docker.p":
    "Containers, images, Compose, networks, volumes — local / remote Engine / SSH host / 1Panel.",
