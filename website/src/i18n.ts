...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.7：插件开放平台与 Host SDK，小程序扫码同步传钥，模块文件夹树同步，远程数据库导出与内存占用优化。",
  "highlights.web.h": "插件平台",
  "highlights.web.p": "签名 .omni-plugin 安装；L2 逻辑包与 L3 沙箱 Overlay；开发者文档就绪",
  ...
  "highlights.termAi.p": "展开阿里云账户后自动发现有 ECS / 轻量实例的地域",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.7: Plugin platform & Host SDK, WeChat scan-to-pair sync, module folder trees, remote DB export & memory fixes.",
  "highlights.web.h": "Plugin platform",
  "highlights.web.p": "Signed .omni-plugin install; L2 logic + L3 sandbox overlay; developer docs ready",
  ...
  "highlights.termAi.p": "Aliyun accounts auto-discover regions with ECS / SWAS instances",
