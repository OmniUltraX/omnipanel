...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.3：SQL 编辑器 Ctrl+点击开表与滚轮缩放，数据库导出体验增强，自定义面板关闭后可再打开。",
  "highlights.web.h": "SQL 编辑器",
  "highlights.web.p": "Ctrl/Cmd+点击表名打开数据面板；Ctrl/Cmd+滚轮缩放字号",
  "highlights.panel.h": "数据库导出",
  "highlights.panel.p": "展示源连接/源库；目标库可输入新建；修复容器内 dump 空密码",
  "highlights.ssh.h": "自定义面板",
  "highlights.ssh.p": "关闭 Tab 不再删除面板，可从「+」菜单再打开",
  "highlights.termAi.h": "SSH · 侧栏",
  "highlights.termAi.p": "主机列表吃剩余空间，隧道/密钥按内容自适应并记忆高度",
  "highlights.db.h": "账号级同步",
  "highlights.db.p": "登录拉取账号级云端快照，多端共享同一份同步数据",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.3: Ctrl+click tables and wheel-zoom in the SQL editor, smoother cross-database export, and custom panels that reopen after close.",
  "highlights.web.h": "SQL editor",
  "highlights.web.p": "Ctrl/Cmd+click a table name to open its data panel; Ctrl/Cmd+wheel to zoom font size",
  "highlights.panel.h": "Database export",
  "highlights.panel.p": "Source connection/database shown; type or create the target database; Docker dump password fix",
  "highlights.ssh.h": "Custom panels",
  "highlights.ssh.p": "Closing a custom dashboard tab no longer deletes it — reopen from the + menu",
  "highlights.termAi.h": "SSH · Sidebar",
  "highlights.termAi.p": "Host list fills remaining space; tunnels/keys auto-size with remembered height",
  "highlights.db.h": "Account sync",
  "highlights.db.p": "Login pulls a shared account-level cloud snapshot across devices",
