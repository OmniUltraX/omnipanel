...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.30：云厂商与 Nacos 改为市场 download-only、知识库思源插件化、插件工作室工程化与 Rubick 源。",
  "highlights.web.h": "云与模块插件",
  "highlights.web.p": "八家云厂商 + Nacos 走插件中心下载安装；独立仓发版；阿里云安全组可删",
  "highlights.panel.h": "同步安全",
  "highlights.panel.p": "新设备小程序扫码配对；主设备自动传钥；密码不进 modules 快照",
  "highlights.ssh.h": "团队同步",
  "highlights.ssh.p": "SSH / Docker / 数据库 / 协议文件夹树；推送/拉取前等待布局 hydration",
  "highlights.termAi.h": "知识库与工作室",
  "highlights.termAi.p": "思源只走插件（S3 / 图片标签）；工作室工程中心、链接工程与热重载",
  "highlights.db.h": "插件市场",
  "highlights.db.p": "Rubick 第三方源与外部插件适配；翻译类转市场下载",
  "highlights.sec.h": "性能",
  "highlights.sec.p": "壳层后台预热与 idle chunk；模块保活秒切；看板隐藏停轮询",
  ...
  "mod.server.p": "系统监控、进程与远程文件；宝塔 / 1Panel / HestiaCP 网站·应用·证书·计划任务；自定义监控面板与小组件；阿里云 / 腾讯云 / 华为云 / AWS / Azure / GCP / DigitalOcean / 搬瓦工在账号上切换地区。",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.30: Cloud vendors + Nacos as download-only marketplace plugins, SiYuan knowledge via plugin, studio project workflow + Rubick source.",
  "highlights.web.h": "Cloud & module plugins",
  "highlights.web.p": "Eight cloud vendors + Nacos install from Plugin Center; independent-repo releases; Aliyun SG delete",
  "highlights.panel.h": "Sync security",
  "highlights.panel.p": "New devices pair via mini-program scan; primary PC auto key transfer; passwords stay out of modules",
  "highlights.ssh.h": "Team sync",
  "highlights.ssh.p": "Folder trees for SSH / Docker / DB / protocol; wait layout hydration before push/pull",
  "highlights.termAi.h": "Knowledge & Studio",
  "highlights.termAi.p": "SiYuan plugin-only (S3 / image tags); project-centric studio, linked projects, hot reload",
  "highlights.db.h": "Plugin marketplace",
  "highlights.db.p": "Rubick third-party source + external plugin adapt; translators move to market download",
  "highlights.sec.h": "Performance",
  "highlights.sec.p": "Shell background warmup + idle chunk; keep-alive module switch; stop widget polling when hidden",
  "modules.eyebrow": "Core Modules",
  ...
  "mod.server.p":
    "System metrics, processes, remote files; BT / 1Panel / HestiaCP sites·apps·certs·cron; custom monitor panels & widgets; Aliyun / Tencent Cloud / Huawei Cloud / AWS / Azure / GCP / DigitalOcean / BandwagonHost region switch on the account.",
