...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.0：自定义监控面板与小组件、宝塔 Docker、Redis 可视化与数据库表预览体验升级。",
  "highlights.web.h": "自定义监控面板",
  "highlights.web.p": "网格拖拽布局；主机 / Docker / MySQL / Redis 等可配置监控小组件",
  "highlights.panel.h": "Docker · 宝塔",
  "highlights.panel.p": "宝塔 Docker 来源、SSH 一键导入、侧栏分组；API 熔断防封禁",
  "highlights.ssh.h": "Redis 可视化",
  "highlights.ssh.p": "Stream 等键类型运维布局与键值预览增强",
  "highlights.termAi.h": "终端 AI",
  "highlights.termAi.p": "直通 Shell Agent、Plan / ask_user 卡片、危险命令二次确认",
  "highlights.db.h": "数据库",
  "highlights.db.p": "可复制表标识、空过滤清空列表、macOS 网格横滚修复",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.0: custom monitor panels & widgets, BT Panel Docker, Redis visual ops, and database preview polish.",
  "highlights.web.h": "Custom monitor panels",
  "highlights.web.p": "Drag-and-drop grid panels with host / Docker / MySQL / Redis widgets",
  "highlights.panel.h": "Docker · BT Panel",
  "highlights.panel.p": "BT Panel Docker source, SSH one-click import, sidebar folders; API circuit breaker",
  "highlights.ssh.h": "Redis visual ops",
  "highlights.ssh.p": "Stream-focused layouts and richer key value preview",
  ...
  "highlights.db.p": "Copyable table identity; empty filter clears rows; macOS grid scroll fix",
