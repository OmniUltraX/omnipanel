...
const zh: Dict = {
  ...
  "highlights.lead": "v0.8.20：插件市场多源安装、Nacos 服务上下线与可拖分栏、模块保活秒切与宝塔应用增强。",
  "highlights.web.h": "插件平台",
  "highlights.web.p": "插件中心：官方目录 + 第三方多源；版本安装 IPC；签名 .omni-plugin；L2 / L3 沙箱",
  "highlights.panel.h": "同步安全",
  "highlights.panel.p": "新设备小程序扫码配对；主设备自动传钥；密码不进 modules 快照",
  "highlights.ssh.h": "团队同步",
  "highlights.ssh.p": "SSH / Docker / 数据库 / 协议文件夹树纳入推送与拉取",
  "highlights.termAi.h": "模块插件",
  "highlights.termAi.p": "Nacos：命名空间切换、服务在线/离线与上线下线、可拖分栏、Ctrl+F 搜配置",
  "highlights.db.h": "面板应用",
  "highlights.db.p": "宝塔已装应用版本/端口；MySQL / Redis 一键管理参数",
  "highlights.sec.h": "性能",
  "highlights.sec.p": "模块保活秒切；看板隐藏停轮询；取消启动预热降低常驻内存",
...
const en: Dict = {
  ...
  "highlights.lead": "v0.8.20: multi-source plugin marketplace, Nacos online/offline + resizable split, keep-alive module switch & BT Panel app upgrades.",
  "highlights.web.h": "Plugin platform",
  "highlights.web.p": "Plugin Center: official catalog + third-party sources; version install IPC; signed .omni-plugin; L2 / L3 sandbox",
  ...
  "highlights.ssh.p": "Folder trees for SSH / Docker / DB / protocol in push & pull",
  "highlights.termAi.h": "Module plugins",
  "highlights.termAi.p": "Nacos: namespace switch, service online/offline, resizable split, Ctrl+F config search",
  ...
  "highlights.sec.p": "Keep-alive module switch; stop widget polling when hidden; lower idle memory",
  "modules.eyebrow": "Core Modules",
