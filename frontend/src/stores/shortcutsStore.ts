...
export const SHORTCUT_DEFS: ShortcutDef[] = [
  ...
  { id: "expand-terminal-blocks", category: "terminal", labelKey: "settings.keybindings.items.expandTerminalBlocks", defaultKeys: ["Mod", "Alt", "ArrowDown"] },
  { id: "collapse-terminal-blocks", category: "terminal", labelKey: "settings.keybindings.items.collapseTerminalBlocks", defaultKeys: ["Mod", "Alt", "ArrowUp"] },
  { id: "toggle-terminal-input-mode", category: "terminal", labelKey: "settings.keybindings.items.toggleTerminalInputMode", defaultKeys: ["Alt", "KeyB"] },
  { id: "command-history", category: "terminal", labelKey: "settings.keybindings.items.commandHistory", defaultKeys: ["Mod", "KeyR"] },
  { id: "explain-last-error", category: "terminal", labelKey: "settings.keybindings.items.explainLastError", defaultKeys: ["Mod", "Shift", "KeyE"] },
  { id: "fix-last-error", category: "terminal", labelKey: "settings.keybindings.items.fixLastError", defaultKeys: ["Mod", "Shift", "KeyF"] },
  ...
  { id: "toggle-terminal-side-monitor", category: "terminal", labelKey: "settings.keybindings.items.toggleTerminalSideMonitor", defaultKeys: ["Alt", "KeyM"] },
  { id: "toggle-terminal-side-files", category: "terminal", labelKey: "settings.keybindings.items.toggleTerminalSideFiles", defaultKeys: ["Alt", "Shift", "KeyF"] },
  { id: "new-ssh", category: "ssh", labelKey: "settings.keybindings.items.newSsh", defaultKeys: ["Mod", "KeyN"] },
  { id: "toggle-terminal-side-sftp", category: "ssh", labelKey: "settings.keybindings.items.toggleTerminalSideSftp", defaultKeys: ["Alt", "KeyP"] },
  { id: "toggle-terminal-side-tunnel", category: "ssh", labelKey: "settings.keybindings.items.toggleTerminalSideTunnel", defaultKeys: ["Alt", "KeyU"] },
  ...
  { id: "format-sql-compact", category: "sqlEditor", labelKey: "settings.keybindings.items.formatSqlCompact", defaultKeys: ["Alt", "Shift", "KeyC"] },
  { id: "run-sql-new-result", category: "sqlEditor", labelKey: "settings.keybindings.items.runSqlNewResult", defaultKeys: ["Mod", "Backslash"] },
  { id: "sql-line-comment", category: "sqlEditor", labelKey: "settings.keybindings.items.sqlLineComment", defaultKeys: ["Mod", "Slash"] },
  { id: "sql-block-comment", category: "sqlEditor", labelKey: "settings.keybindings.items.sqlBlockComment", defaultKeys: ["Shift", "Alt", "KeyA"] },
  { id: "sql-expand-star", category: "sqlEditor", labelKey: "settings.keybindings.items.sqlExpandStar", defaultKeys: ["Mod", "Shift", "KeyX"] },
  { id: "sql-send-to-ai", category: "sqlEditor", labelKey: "settings.keybindings.items.sqlSendToAi", defaultKeys: ["Mod", "Shift", "KeyA"] },
  { id: "sql-upper", category: "sqlEditor", labelKey: "settings.keybindings.items.sqlUpper", defaultKeys: ["Shift", "Alt", "KeyU"] },
  { id: "sql-lower", category: "sqlEditor", labelKey: "settings.keybindings.items.sqlLower", defaultKeys: ["Shift", "Alt", "KeyL"] },
