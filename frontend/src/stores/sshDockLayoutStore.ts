...
const STORAGE_KEY = "omnipanel.sshDockLayout.v1";
const STORAGE_VERSION = 1;

interface SshDockLayoutState {
  savedLayout: SerializedDockview | null;
  setSavedLayout: (layout: SerializedDockview | null) => void;
  reset: () => void;
}

export const useSshDockLayoutStore = create<SshDockLayoutState>()(
  persist(
    (set) => ({
      savedLayout: null,
...
export function removeTabFromSshLayout(
  savedLayout: SerializedDockview | null,
  tabId: string,
