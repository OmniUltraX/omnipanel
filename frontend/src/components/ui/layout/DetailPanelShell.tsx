...
import { SubWindow } from "../window/SubWindow";
...
/** 全局详情面板模式切换（右侧抽局ↀ浮动窗口），偏好持久化于 settingsStore　*/
...
/** 一global.css 一drawer / docker-drawer 皀transition 时长一臀*/
const DRAWER_ANIMATION_MS = 300;

/**
 * 详情面板壳层：根据全局配置在「右侧抽屉」与「浮劀SubWindow」间切换　
