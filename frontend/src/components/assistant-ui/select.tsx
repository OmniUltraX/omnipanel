...
const SelectContent = ({
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      sideOffset={6}
      className={cn(
        "bg-popover/95 text-popover-foreground relative z-[var(--z-subwindow-popover)] max-h-96 min-w-[8rem] overflow-hidden rounded-md border p-1.5 shadow-lg backdrop-blur-sm",
