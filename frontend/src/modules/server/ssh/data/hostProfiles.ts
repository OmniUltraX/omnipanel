...
export const HOST_PROFILES: Record<string, HostProfile> = {
  "prod-web-01": {
    ...
    relatedModules: [
      ...
      { label: "Workflow 发布", desc: "跳转部署 / 巡检工作流", path: "/module/workflow" },
      { label: "终端工作区", desc: "进入统一终端与 AI 协同界面", path: "/module/terminal" },
    ],
    notes: [
  ...
  "prod-web-02": {
    ...
    relatedModules: [
      { label: "终端工作区", desc: "进入会话编排中心", path: "/module/terminal" },
      { label: "Workflow 发布", desc: "查看发布链路与历史", path: "/module/workflow" },
    ],
  ...
  "staging-bastion": {
    ...
    relatedModules: [
      ...
      { label: "Workflow 巡检", desc: "进入巡检 / 历史记录", path: "/module/workflow" },
      { label: "终端工作区", desc: "打开中转会话工作台", path: "/module/terminal" },
    ],
  ...
  default: {
    ...
    relatedModules: [{ label: "终端工作区", desc: "进入统一终端", path: "/module/terminal" }],
