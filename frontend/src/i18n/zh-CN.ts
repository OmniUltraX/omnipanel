export const zhCN = {
  ...
  settings: {
    ...
    knowledge: {
      ...
      embeddingModelDesc: "文档解析时使用的向量化模型，可从已配置模型中选择或单独指定 OpenAI 兼容接口",
      embeddingModelMode: {
        configured: "从已配置模型选择",
        custom: "自定义 Embedding 模型",
      },
      embeddingConfiguredEmpty: "请先在「AI 模型」中添加 OpenAI 兼容模型",
      embeddingCustomModelName: "模型名称",
      embeddingCustomModelNamePlaceholder: "如 text-embedding-3-small",
      embeddingCustomBaseUrl: "API Base URL",
      embeddingCustomApiKey: "API Key",
      embeddingCustomApiKeyPlaceholder: "sk-…",
      embeddingCustomHint: "需为 OpenAI 兼容的 Embedding 接口（/embeddings）",
      embeddingCustomIncomplete: "请填写有效的模型名称与 API Base URL",
    },
    data: {
      title: "数据与备份",
