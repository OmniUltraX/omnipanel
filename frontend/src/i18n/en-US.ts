...
export const enUS: TranslationDict = {
  ...
  settings: {
    ...
    knowledge: {
      ...
      embeddingModelDesc: "Model used when parsing documents; pick from configured models or specify a custom OpenAI-compatible endpoint",
      embeddingModelMode: {
      ...
      embeddingCustomModelName: "Model name",
      embeddingCustomModelNamePlaceholder: "e.g. text-embedding-3-small",
      embeddingCustomBaseUrl: "API Base URL",
      embeddingCustomApiKey: "API Key",
      embeddingCustomApiKeyPlaceholder: "sk-…",
      embeddingCustomHint: "Must be an OpenAI-compatible embedding API (/embeddings)",
      embeddingCustomIncomplete: "Enter a valid model name and API Base URL",
    },
    data: {
      title: "Data & Backup",
