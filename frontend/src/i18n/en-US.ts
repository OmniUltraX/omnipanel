...
export const enUS: TranslationDict = {
  ...
  settings: {
    ...
    webSearch: {
      title: "Web search",
      desc: "Configure omni_web_search / omni_web_fetch backends and Exa API key.",
      ...
      backendAuto: "Auto (Exa → DuckDuckGo → Jina)",
      backendExa: "Exa",
      backendDdg: "DuckDuckGo",
      backendJina: "Jina",
      exaKey: "Exa API key",
      exaKeyHint: "Without a key, Exa is skipped; auto mode falls back to DuckDuckGo / Jina",
      ...
      testBackend: "Test current backend",
      testing: "Testing…",
    },
    cliProviders: {
      title: "CLI Providers",
