...
export const enUS: TranslationDict = {
  app: {
    ...
    splash: {
      ...
      logs: {
        ...
        acpServices: "Loading CLI agent settings…",
  ...
  database: {
    ...
    connectionInfo: {
      ...
      variablesSessionSave: "Session",
      variablesGlobalSave: "Global",
      variablesSaveFailed: "Save failed: {message}",
      configEditor: {
        open: "Edit MySQL config file",
        title: "MySQL Config File",
        notFound: "MySQL config file not found",
        noSsh: "No matching SSH connection; cannot access the config file on the remote host",
        saveFailed: "Failed to save config file: {message}",
      },
      deployment: {
        label: "Deployment",
        detecting: "Detecting…",
    ...
    toolbox: {
      ...
      side: {
        ...
        rowDiffLoadingAll: "Loading all conflicting rows…",
  ...
  terminal: {
    ...
    command: {
      ...
      attachToAi: "Add to AI context",
      attachSuccess: "Block added to AI input context",
      attachDuplicate: "Block already in context",
      attachEmpty: "Nothing to attach",
      attachedContext: "Context: {label}",
      detachAttachedContext: "Remove this block from context",
  ...
  settings: {
    ...
    accounts: {
      ...
      desc: "Manage API keys or username/password credentials for GitHub, GitLab, cloud providers, and more. Secrets are stored in the system keychain.",
      loading: "Loading accounts…",
      dialogDesc: "Pick a platform and auth method. Secrets are stored in the local keychain only, not in the database.",
      save: "Save",
      editBtn: "Edit",
      deleteBtn: "Delete",
      ...
      empty: {
        ...
        desc: "Add GitHub tokens, Docker Hub credentials, etc. for reuse across modules.",
      ...
      fields: {
        ...
        apiKeyPlaceholder: "Paste a personal access token or API key",
        password: "Password",
        passwordPlaceholder: "Login password",
        secretEditHint: "Leave blank to keep the existing credential",
        notes: "Notes",
        notesPlaceholder: "Optional, e.g. purpose or expiry reminder",
      },
      authMethods: {
      ...
      errors: {
        ...
        usernameRequired: "Username is required for password authentication",
        secretRequired: "API key or password is required",
      },
    },
    mcpTools: {
      label: "MCP tools",
    ...
    aiServices: {
      title: "AI Services",
      desc: "Agent Router (:8765) and OmniMCP (:12756) are configured independently.",
      ...
      router: {
        ...
        bindLan: "Bind LAN",
        bindLanDesc: "Listen on 0.0.0.0 — use with care in production",
        curlTitle: "curl example",
        copyCurl: "Copy curl",
      },
      omnimcp: {
        desc: "OmniMCP listens on {url} for external agents such as Cursor or Claude Code.",
        requireApproval: "Require approval for external calls",
        requireApprovalDesc: "High-risk external MCP calls (e.g. terminal) require user confirmation",
        toolsTitle: "Externally exposed tools",
        toolsDesc: "Choose which built-in tools are visible via OmniMCP per module. Read-only tools (connection lists, knowledge) can be called by external agents directly; tools that need a desktop session (terminal, SQL) can be exposed now with direct-call support coming later.",
        toolsEmpty: "No built-in tools",
        toolModuleClosed: "Module is closed — external exposure cannot be enabled",
        toolsUiDelegatedHint: "Tools enabled for external exposure appear in the live list below; tools with backend handlers can be invoked directly by external agents (database queries, local shell, knowledge, Skills, etc.).",
        liveToolsTitle: "Currently exposed tools",
        liveToolsDesc: "Fetched live from OmniMCP (:12756). Only tools with external exposure enabled and an open module are shown.",
    ...
    builtinTools: {
      ...
      desc: "Native OmniPanel tools. Internal availability controls whether internal AI orchestration loads the tool. Configure external exposure under AI Services → OmniMCP.",
      internal: "Internal",
      external: "External",
      moduleDesc: "{count} tool(s)",
