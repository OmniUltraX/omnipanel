  ...
  database: {
    ...
    toolbox: {
      ...
      side: {
        ...
        strategyMergeSource: "Merge (source)",
        strategyMergeTarget: "Merge (target)",
        strategyConflictSource: "Conflict only (source)",
        strategyConflictTarget: "Conflict only (target)",
        strategyTarget: "Target",
        strategySourceHint: "Use all source table data (truncate target, then sync)",
        strategyMergeSourceHint: "Insert source-only rows; for rows in both tables, conflicting fields use source values",
        strategyMergeTargetHint: "Skip source-only rows; for rows in both tables, conflicting fields keep target values",
        strategyConflictSourceHint: "Only rows present in both tables; conflicting fields use source values",
        strategyConflictTargetHint: "Only rows present in both tables; conflicting fields keep target values",
        strategyTargetHint: "Keep all target table data (skip data sync for this table)",
        strategySelectLabel: "Merge strategy for conflict table",
        syncTableSubmit: "Apply",
        syncTableSubmitHint: "Sync this table with the selected strategy",
