export default {
    ...
    tree: {
      ...
      rename: "Rename",
      duplicate: "Duplicate",
      convertToLocal: "Convert to local copy",
      dragMirrorDenied: "Mirrored docs are read-only and cannot be moved (sync would move them back)",
      dropMirrorDenied: "Mirror folders are read-only",
      deleteMirrorDenied: "Skipped {count} mirrored item(s): delete at the source, then rebuild sync",
      renameMirrorDenied: "Mirrored docs are read-only; convert to a local copy to edit",
      mirrorSources: {
        siyuan: "SiYuan",
        "siyuan-s3": "SiYuan S3",
        obsidian: "Obsidian",
    ...
    siyuan: {
      mirrorBadge: "SiYuan mirror",
    },
    ks: {
      title: "Knowledge sources",
      openButton: "Sources",
      empty: "No knowledge-source plugins installed, visit the market",
      loading: "Loading…",
      close: "Close",
      save: "Save",
      ...
      testing: "Testing…",
      testOk: "Found {notebooks} notebooks/folders with {docs} documents",
      syncNow: "Sync now",
      syncing: "Syncing…",
      rebuild: "Rebuild sync",
      rebuildHint: "Clear sync state and re-evaluate everything (for broken retries, no duplicates)",
      syncDone: "Synced: {added} added, {updated} updated, {archived} archived, {failed} failed",
