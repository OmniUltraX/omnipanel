export default {
    ...
    siyuan: {
      ...
      openButton: "SiYuan sync",
      sourceLocal: "Local directory",
      sourceS3: "S3 object storage",
      sourceS3Pending: "S3 source is under development, unavailable for now",
      workspacePath: "Workspace data directory",
      workspacePlaceholder: "e.g. D:\\SiYuan\\data",
      browse: "Browse…",
      s3Endpoint: "Endpoint",
      s3Bucket: "Bucket",
      s3Region: "Region",
      ...
      testing: "Testing…",
      testOk: "Found {notebooks} notebooks with {docs} documents",
      syncNow: "Sync now",
      syncing: "Syncing…",
