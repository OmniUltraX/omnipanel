export default {
    ...
    aiServices: {
      title: "MCP Server",
      desc: "OmniPanel exposes a single MCP Server (OmniMCP) for third-party agents to call local tools.",
      ...
      omnimcp: {
        desc: "OmniMCP listens on {url} for external agents.",
        ...
        copyToml: "Copy TOML",
        toolsTitle: "Tools",
        toolsDesc: "Switch modules with the segmented control. Toggle exposure via OmniMCP.",
        ...
        agentsConfigTitle: "Agent configs",
        agentsConfigDesc: "Paste each snippet into the matching agent config. Server URL: {url}",
        agents: {
          opencode: {
            title: "OpenCode",
          ...
          cursor: {
            title: "Cursor",
            hint: "Add to Cursor MCP settings (mcp.json)",
          },
          claudeCode: {
            title: "Claude Code",
            hint: "Add to project .mcp.json or ~/.claude.json",
          },
          codex: {
            title: "Codex",
