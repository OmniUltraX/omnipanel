export default {
    ...
    miniapp: {
      ...
      retry: "Retry",
      assistantListTitle: "Assistants authorized for this org",
      assistantListTitleWithTeam: "{team} · Authorized assistants",
      assistantListEmpty: "No assistants authorized for this org",
      assistantUnbind: "Revoke",
      assistantUnbindConfirm:
        "Revoke \"{name}\" for \"{team}\"? Other organizations are unaffected.",
      assistantUnbindSuccess: "Revoked for this organization",
      assistantUnbindFailed: "Failed to revoke",
      assistantLoading: "Loading…",
      assistantBindNew: "Scan to authorize another",
      assistantBackToList: "Back to assistant list",
      assistantNeedLogin: "Sign in before authorizing an assistant",
      assistantNeedTeam: "Select a sync organization first",
      assistantConfirmBound: "I've scanned — add to this org",
      assistantConfirmBoundDone: "Added to this organization",
      assistantConfirmBoundEmpty: "No assistant devices on this account yet",
      assistantBoundBelow: "Currently bound assistants",
      assistantOnline: "Online",
      teamKeyQrTitle: "Organization sync key",
      teamKeyQrTitleWithTeam: "{team} · Sync key",
      teamKeyQrAlt: "Organization sync key QR code",
      teamKeyHint:
        "Scan with the mini program (same WeChat account) to receive this organization's sync key. Scan again per organization.",
    },
    topbar: {
    ...
    quickLauncher: {
      ...
      slash: {
        tag: "Cmd",
        commandsSection: "Slash commands",
        noResults: "No matching commands, models, or dashboards",
        model: {
          label: "/model",
          desc: "Switch the AI assistant model",
          tag: "Model",
        ...
        dash: {
          label: "/dash",
          desc: "Open a dashboard or custom panel",
          tag: "Dash",
          section: "Choose dashboard",
          current: "Current",
          untitled: "Untitled panel",
          builtinSub: "Built-in board",
          customSub: "Custom · {n} widgets",
        },
      },
      ai: {
        title: "AI",
