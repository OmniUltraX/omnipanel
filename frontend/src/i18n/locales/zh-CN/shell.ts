export default {
    ...
    miniapp: {
      ...
      loadFailed: "二维码加载失败",
      retry: "重试",
      assistantListTitle: "当前组织已授权的助手",
      assistantListTitleWithTeam: "{team} · 已授权助手",
      assistantListEmpty: "当前组织暂无授权助手",
      assistantUnbind: "取消授权",
      assistantUnbindConfirm: "取消「{name}」在「{team}」的密钥授权？不影响其他组织。",
      assistantUnbindSuccess: "已取消本组织授权",
      assistantUnbindFailed: "取消授权失败",
      assistantLoading: "加载中…",
      assistantBindNew: "扫码授权新助手",
      assistantBackToList: "返回助手列表",
      assistantNeedLogin: "请先登录后再授权助手",
      assistantNeedTeam: "请先选择同步组织",
      assistantConfirmBound: "我已扫码，加入本组织",
      assistantConfirmBoundDone: "已加入当前组织",
      assistantConfirmBoundEmpty: "账号下暂无助手设备，请先在小程序登录并绑定",
      assistantBoundBelow: "当前已绑定的助手",
      assistantOnline: "在线",
      teamKeyQrTitle: "组织同步密钥",
      teamKeyQrTitleWithTeam: "{team} · 同步密钥",
      teamKeyQrAlt: "组织同步密钥二维码",
      teamKeyHint: "用已登录同一账号的小程序扫码，接收当前组织的同步密钥（可对多个组织分别扫码）",
    },
    topbar: {
