...
export const commands = {
	...
	cloudGetMetrics: (connectionId: string, capability: string, resourceId: string, regionId: string | null, query: {
	metricIds?: string[],
	startMs?: number,
	endMs?: number,
	periodSec?: number,
} | null) => typedError<CloudMetricSeries[], OmniError_Serialize>(__TAURI_INVOKE("cloud_get_metrics", { connectionId, capability, resourceId, regionId, query })),
	cloudQueryLogs: (connectionId: string, capability: string, resourceId: string, regionId: string | null, query: {
	kind?: string,
	startMs?: number,
	endMs?: number,
	page?: number,
	...
	sortDir?: string,
	keyword?: string,
} | null) => typedError<CloudLogPage, OmniError_Serialize>(__TAURI_INVOKE("cloud_query_logs", { connectionId, capability, resourceId, regionId, query })),
	...
	pluginStudioEnvCheck: () => typedError<StudioEnv_Serialize, OmniError_Serialize>(__TAURI_INVOKE("plugin_studio_env_check")),
	/**  按白名单安装本机工具链（Windows 优先 winget / rustup-init；安装后刷新 PATH 再探测）。 */
	pluginStudioEnvInstall: (tool: string) => typedError<StudioEnvInstallResult_Serialize, OmniError_Serialize>(__TAURI_INVOKE("plugin_studio_env_install", { tool })),
	/**  校验走清单 Rust 解析；打包走 `omnipanel-plugin-pkg::pack_dir`（dev 签名，可本地安装）。 */
	pluginStudioRun: (project: string, op: string) => typedError<StudioRunResult_Serialize, OmniError_Serialize>(__TAURI_INVOKE("plugin_studio_run", { project, op })),
	...
	pluginRegistrySourceTest: (id: string) => typedError<SourceTestResult_Serialize, OmniError_Serialize>(__TAURI_INVOKE("plugin_registry_source_test", { id })),
	 ...
	 */
	authApiRequest: (token: string, method: string, path: string, body: string | null, deviceId: string | null, appId: string | null) => typedError<AuthApiResponse, OmniError_Serialize>(__TAURI_INVOKE("auth_api_request", { token, method, path, body, deviceId, appId })),
...
export type ExternalVerdictDto = ExternalVerdictDto_Serialize | ExternalVerdictDto_Deserialize;

export type ExternalVerdictDto_Deserialize = {
	npm: string,
	version: string,
	runnable: boolean,
	reasons: string[],
...
export type ExternalVerdictDto_Serialize = {
	npm: string,
	version: string,
	runnable: boolean,
	reasons: string[],
...
export type MarketplaceItem = MarketplaceItem_Serialize | MarketplaceItem_Deserialize;

export type MarketplaceItem_Deserialize = {
	id: string,
	kind: PluginKind,
	name: string,
	description: string,
...
export type MarketplaceItem_Serialize = {
	id: string,
	kind: PluginKind,
	name: string,
	description: string,
...
export type PluginUpdateInfo = PluginUpdateInfo_Serialize | PluginUpdateInfo_Deserialize;

export type PluginUpdateInfo_Deserialize = {
	id: string,
...
export type PluginUpdateInfo_Serialize = {
	id: string,
	installedVersion: string,
	latestVersion: string,
	changelog?: string | null,
...
export type SourceTestResult = SourceTestResult_Serialize | SourceTestResult_Deserialize;

export type SourceTestResult_Deserialize = {
	ok: boolean,
	pluginCount: number,
	error?: string | null,
};

export type SourceTestResult_Serialize = {
	ok: boolean,
	pluginCount: number,
	error?: string | null,
};
...
export type StudioEnv = StudioEnv_Serialize | StudioEnv_Deserialize;

export type StudioEnvInstallResult = StudioEnvInstallResult_Serialize | StudioEnvInstallResult_Deserialize;

export type StudioEnvInstallResult_Deserialize = {
	tool: string,
	ok: boolean,
	output: string,
	version?: string | null,
...
export type StudioEnvInstallResult_Serialize = {
	tool: string,
	ok: boolean,
	output: string,
	version?: string | null,
...
export type StudioEnv_Deserialize = {
	cargo?: string | null,
	node?: string | null,
...
export type StudioEnv_Serialize = {
	cargo?: string | null,
	node?: string | null,
	wat2wasm?: string | null,
	repoRoot: string | null,
...
export type StudioProject = StudioProject_Serialize | StudioProject_Deserialize;

export type StudioProject_Deserialize = {
	name: string,
	files: string[],
	hasManifest: boolean,
...
export type StudioRunResult_Deserialize = {
	success: boolean,
	output: string,
	artifactPath?: string | null,
};

export type StudioRunResult_Serialize = {
	success: boolean,
	output: string,
	artifactPath?: string | null,
};
...
export type UpdateResultItem = UpdateResultItem_Serialize | UpdateResultItem_Deserialize;

export type UpdateResultItem_Deserialize = {
	id: string,
	ok: boolean,
	error?: string | null,
};

export type UpdateResultItem_Serialize = {
	id: string,
	ok: boolean,
	error?: string | null,
};
