...
use crate::commands::local_runtime::{install_ollama_with_progress, pull_ollama_with_progress};
...
pub async fn run_ollama_install_background(
    ...
    progress("开始安装 Ollama…".into(), 0, 100, None, None);
...
pub async fn run_ollama_pull_background(
    ...
    progress(format!("准备拉取 {model}…"), 0, 100, None, None);
