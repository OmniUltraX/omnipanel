...
fn export_ipc_bindings() {
    ...
    let builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        commands::terminal_history::terminal_history_remove_block,
        commands::terminal_history::terminal_history_clear_session,
        commands::terminal_history::terminal_history_clear_all,
        ...
        commands::secrets_vault::secrets_vault_lock,
        commands::secrets_vault::secrets_vault_push,
        commands::secrets_vault::secrets_vault_pull,
        ...
        commands::database::db_patch_schema_cache,
        commands::database::db_test_connection,
        commands::database::db_list_databases,
        commands::database::db_list_databases_with_stats,
        ...
        commands::database::db_execute_query_in_session,
        commands::database::db_query_session_commit,
        commands::database::db_query_session_rollback,
        commands::database::db_query_session_close,
        ...
        commands::panel::panel_1panel_upload_file,
        commands::panel::panel_bt_request,
        commands::panel::panel_bt_app_icon,
        commands::panel::panel_bt_test_connection,
        commands::cloud::cloud_test,
        commands::cloud::cloud_list_oss,
        ...
        commands::docker::docker_clear_container_logs,
        commands::docker::docker_list_container_log_infos,
        ...
        commands::docker::docker_search_images,
        ...
        commands::docker::docker_read_compose_files,
        commands::docker::docker_write_compose_files,
        ...
        commands::docker::docker_load_sidebar_cache,
        commands::docker::docker_patch_sidebar_cache,
        commands::docker::docker_remove_sidebar_cache,
        commands::docker::docker_list_sidebar_cache_page,
        ...
        commands::docker::docker_list_volume_dir,
        commands::docker::docker_read_volume_file,
        ...
        commands::docker::docker_host_run_cli,
        ...
        commands::ssh::ssh_connect_connection,
        ...
        commands::ssh::ssh_tmux_list_windows,
        ...
        commands::ssh::sftp_log_open,
        commands::ssh::sftp_log_read_lines,
        commands::ssh::sftp_log_tail_initial,
        commands::ssh::sftp_log_search,
        commands::ssh::sftp_log_tail_start,
        commands::ssh::sftp_log_tail_stop,
        commands::local_file_log::local_log_open,
        commands::local_file_log::local_log_read_lines,
        commands::local_file_log::local_log_tail_initial,
        commands::local_file_log::local_log_search,
        commands::local_file_log::local_log_tail_start,
        commands::local_file_log::local_log_tail_stop,
        commands::ssh::ssh_pool_download_install_binary,
        ...
        commands::file_manager::file_s3_search,
        ...
        commands::todo::todo_list_list,
        commands::todo::todo_list_save,
        commands::todo::todo_list_delete,
        commands::todo::todo_task_list,
        commands::todo::todo_task_get,
        commands::todo::todo_task_save,
        ...
        commands::tag::tag_set_color,
        commands::tag::resource_list_tags,
        commands::tag::resource_set_tags,
        commands::tag::resource_add_tag,
        commands::tag::resource_remove_tag,
        commands::tag::resource_set_system_tag,
        commands::tag::tag_query_resources,
        commands::tag::tag_suggest,
        commands::tag::search_everywhere,
        ...
        commands::protocol::http_list_environments,
        commands::protocol::http_save_environment,
        commands::protocol::http_delete_environment,
        ...
        commands::db_tree_chart_files::db_tree_chart_files_save,
        commands::db_sync_diff_cache::db_sync_row_diff_page,
        commands::builtin_tool::builtin_tool_list,
        commands::builtin_tool::builtin_tool_set_enabled,
        ...
        commands::client_sync_modules::client_sync_import_from_device,
        // MCP 服务管理
