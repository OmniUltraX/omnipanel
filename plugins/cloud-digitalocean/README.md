# omni-plugin-cloud-digitalocean

OmniPanel 可选插件：`omni.cloud.digitalocean`（DigitalOcean）。
...
宿主仓库以 git submodule 挂载于 `plugins/cloud-digitalocean`。
...
制品文件名固定：`omni-cloud-digitalocean-<version>.omni-plugin`。
