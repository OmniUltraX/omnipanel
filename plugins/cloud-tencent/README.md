# omni-plugin-cloud-tencent

OmniPanel 可选插件：`omni.cloud.tencent`（腾讯云）。
...
宿主仓库以 git submodule 挂载于 `plugins/cloud-tencent`。
...
制品文件名固定：`omni-cloud-tencent-<version>.omni-plugin`。
