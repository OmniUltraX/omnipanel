# omni-plugin-cloud-huawei

OmniPanel 可选插件：`omni.cloud.huawei`（华为云）。
...
宿主仓库以 git submodule 挂载于 `plugins/cloud-huawei`。
...
制品文件名固定：`omni-cloud-huawei-<version>.omni-plugin`。
